...
import { cartView, productsView, productDetailView , privateAccess, publicAccess, mockingProductsView, loggerTest } from '../../controllers/views.controllers.js';
...
router.get('/loggerTest', publicAccess, loggerTest)
